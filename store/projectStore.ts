...
export const useProjectStore = defineStore<string, ProjectStore>("projectStore", () => {
    const projects = [
        ...
        },
        {
            ...
            description:
                "Project that i used only HTML and CSS, to study",
            tech: ["Python"],
        ...
        },
        {
            ...
            description:
                "Project that i used carbon and vue and others technologies, when i started the intern at IBM",
        ...
        },
        {
            ...
            image: images["../assets/featured/futureProject.png"],
            description:
                "It's a project that i'm currently working on to understand and learn more",
            tech: ["Python"],
            link: "https://github.com/malupressler/PythonStudy",
            featured: true,
        },
    ];
